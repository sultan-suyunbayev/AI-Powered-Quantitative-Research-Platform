...
check(
    "trades simulated flagged", j.get("simulated") is True and j.get("data_source") == "demo_mock"
)

# /api/risk/summary -> no hardcoded SAFE
r = c.get("/api/risk/summary")
j = r.json()
