...
class FeatureSpec:
    ...
    def __post_init__(self) -> None:
        if (
            ...
            # 1 бар 4h = 240 минут
            # 4h = 1 бар = 240 минут (ret_4h)
            # 12h = 3 бара = 720 минут (ret_12h)
            # 24h = 6 баров = 1440 минут (ret_24h)
            # 3.5d = 21 бар = 5040 минут (sma_21)
            # 7d = 42 бара = 10080 минут (ret_7d)
            # 8.3d = 50 баров = 12000 минут (sma_50)
            self.lookbacks_prices = [240, 720, 1440, 5040, 10080, 12000]
