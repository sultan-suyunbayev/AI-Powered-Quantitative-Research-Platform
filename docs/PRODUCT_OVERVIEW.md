...
## For Startup Visa Committees (What to Evaluate)
...
- **EU contribution**: primary establishment path is a Netherlands B.V., with local hiring as the business scales (see `docs/BUSINESS_PLAN_EU_VISA.md`).
...
**MVP / Beachhead (equities-first)**: default production support and positioning start with listed equities; adjacent asset classes are enabled based on validated customer pull.
