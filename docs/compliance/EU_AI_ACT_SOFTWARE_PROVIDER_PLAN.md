...
class AIDisclosure:
    ...
    ai_system_name: str = "Distributional PPO Research Model"
    ai_system_type: str = "Reinforcement Learning"
    ai_purpose: str = "Quantitative research output generation"
        ...
        texts = {
            "en": {
                ...
                "body": (
                    ...
                    "Model outputs (e.g., indicators, forecasts, and reports) are generated by the AI model, "
            ...
            "ru": {
                ...
                "body": (
                    ...
                    "Выходные данные модели (например, индикаторы, прогнозы и отчёты) генерируются ИИ-моделью, "
...
Before using live execution features (via the customer-controlled Agent), you must acknowledge that you understand you are interacting with an AI system and accept the associated limitations and risks.
...
def create_default_summary() -> TrainingDataSummary:
    ...
    return TrainingDataSummary(
        model_name="Distributional PPO Research Model",
        model_version="4.0",
...
**Model**: Distributional PPO Research Model v4.0
...
class TestTrainingDataSummary:
    ...
    def test_create_default_summary(self):
        ...
        assert summary.model_name == "Distributional PPO Research Model"
...
def create_default_model_card() -> GPAIModelCard:
    ...
    return GPAIModelCard(
        ...
        human_oversight_recommendations=[
            ...
            "Review anomalous outputs before execution",
...
2. Model outputs (e.g., indicators, forecasts, and reports) are generated by the AI model,
   not by human analysts.

3. I am interacting with an AI system when using the analysis and deployment features
   of this platform.
""",
