...
GARCH_WINDOWS_OPTION_1 = [42, 84, 180]
# 42 бара = 7 дней (~40 часов данных)
# 84 бара = 14 дней
# 180 баров = 30 дней
...
6. GARCH:
   - ВАРИАНТ 1: [42, 84, 180] баров (7d, 14d, 30d)
...
- GARCH либо удален, либо использует длинные окна (7-30 дней)
