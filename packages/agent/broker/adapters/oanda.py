    ...
    def connect(self) -> bool:
        ...
        if hasattr(self._a, "connect") and not bool(self._a.connect()):
            raise ConnectionError(
                getattr(self._a, "last_error", None) or "OANDA connect returned false"
            )
    ...
    def positions(self) -> List[Dict[str, Any]]:
        ...
        try:
            for p in self._a.get_positions() or []:
                out.append(
                    {
                        "symbol": getattr(p, "symbol", getattr(p, "instrument", "")),
    ...
    def account(self) -> Dict[str, Any]:
        try:
            ...
            return {
                ...
                "buying_power": float(
                    getattr(a, "buying_power", getattr(a, "margin_available", 0)) or 0
                ),
            }
        except Exception:
            return {}
    ...
    def __init__(
        ...
        **kw,
        ...
        if credentials is not None:
            ...
            cfg.setdefault(
                "account_id",
                getattr(credentials, "subaccount", "")
                or getattr(credentials, "extra", {}).get("account_id", ""),
            )
        self._config = cfg
