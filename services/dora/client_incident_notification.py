...
class DORAClientNotification:
    ...
    Usage:
        ...
        notifier = DORAClientNotification(config)
    ...
    def __init__(self, config: Optional[ClientNotificationConfig] = None):
        ...
        logger.info("DORAClientNotification initialized")
...
def create_client_notification_system(
    ...
    """
    Create a DORAClientNotification instance.

    Args:
        config: Optional configuration

    Returns:
        Configured DORAClientNotification instance
    """
    return DORAClientNotification(config=config)
