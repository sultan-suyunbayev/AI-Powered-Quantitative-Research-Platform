...
def test_build_forex_exposures_minimal():
    ...
    B = build_forex_exposures(
        rw,
        carries={"EURUSD": 0.0, "GBPUSD": 0.01, "AUDUSD": 0.04},
    ...
    cfg = XSConfig.model_validate(
        {
            ...
            "signals": [
                {"name": "m", "kind": "fx_momentum", "lookback": 60, "transforms": ["zscore"]},
