...
class TestTermsOfServiceCCEA:
    ...
    def tos_content(self):
        """Load ToS content."""
        tos_path = (
            Path(__file__).parent.parent.parent.parent / "docs" / "legal" / "TERMS_OF_SERVICE.md"
        )
...
class TestPrivacyPolicyCCEA:
    ...
    def pp_content(self):
        ...
        pp_path = (
            Path(__file__).parent.parent.parent.parent / "docs" / "legal" / "PRIVACY_POLICY.md"
        )
...
class TestDORACompliance:
    ...
    def dora_content(self):
        ...
        dora_path = (
            ...
            / "docs"
            / "DORA_OPERATIONAL_RESILIENCE_PLAN.md"
        )
