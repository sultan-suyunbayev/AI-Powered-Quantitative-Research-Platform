...
def test_upgd_bias_correction_first_step():
    ...
    assert scale_p2 > scale_p1, "Low utility parameter should receive larger updates than high utility parameter"
...
def test_adaptive_upgd_bias_correction_first_step():
    ...
    optimizer = AdaptiveUPGD([p1, p2], lr=1.0, beta_utility=0.999, sigma=0.0, weight_decay=0.0,
                             beta1=0.0, beta2=0.0)
