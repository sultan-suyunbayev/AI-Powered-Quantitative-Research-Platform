    ...
    return {
        "facts": {
            "us-gaap": {
                ...
                "NetCashProvidedByUsedInOperatingActivities": node(
                    "USD",
                    [
                ...
                "PaymentsToAcquirePropertyPlantAndEquipment": node(
                    "USD",
                    [
            ...
            "dei": {
                "EntityCommonStockSharesOutstanding": node(
                    "shares",
                    [
                        {"filed": "2023-02-01", "end": "2022-12-31", "accn": "A1", "val": 10.0},
...
def test_build_frame_via_DI():
    ...
    assert set(["publish_ts", "symbol", "earnings", "book_value", "fcf", "roe"]).issubset(
        frame.columns
    )
