...
class TestCritical1_DefaultParameters(unittest.TestCase):
    ...
    def test_default_lookbacks_prices_for_4h(self):
        ...
        self.assertEqual(
            spec._lookbacks_prices_minutes,
            expected_minutes,
...
class TestCritical2_FeatureNamesMatch(unittest.TestCase):
    ...
    def test_generated_feature_names_for_4h(self):
        ...
        spec = FeatureSpec(
            lookbacks_prices=[240, 720, 1200, 1440, 5040, 10080, 12000], bar_duration_minutes=240
        )
    ...
    def test_format_window_name_for_4h(self):
        ...
        self.assertEqual(
            _format_window_name(12000), "200h", "12000 минут = 200 часов (не кратно дню)"
        )
...
class TestMajor1_ParkinsonFormula(unittest.TestCase):
    ...
    def test_parkinson_requires_80_percent_valid_bars(self):
        ...
        valid_bars = [{"high": 101.0, "low": 99.0} for _ in range(10)]
        ...
        mixed_bars = [{"high": 101.0, "low": 99.0} for _ in range(8)] + [
        ...
        few_valid_bars = [{"high": 101.0, "low": 99.0} for _ in range(7)] + [
...
class TestIntegrationEnd2End(unittest.TestCase):
    ...
    def test_full_pipeline_with_4h_defaults(self):
        ...
        expected_features = [
            ...
            "garch_200h",
            "garch_14d",
            "garch_30d",  # КРИТИЧНО: garch_200h = 50 баров (минимум для GARCH)
            "yang_zhang_48h",
            "yang_zhang_7d",
            "yang_zhang_30d",
            "parkinson_48h",
