...
def test_pdt_check_no_restriction():
    payload = {"position_value": 100000.0, "account_equity": 30000.0, "day_trades": 2}
...
def test_options_greeks():
    payload = {"spot": 180.0, "strike": 180.0, "dte": 30.0, "vol": 0.20, "rate": 0.05}
...
def test_futures_span():
    payload = {"positions": [{"symbol": "ESM6", "qty": 5}, {"symbol": "NQM6", "qty": 2}]}
...
def test_kill_switch_lifecycle():
    # Trip the switch
    payload = {"scope": "ALL", "reason": "TEST_RUN", "active": True}
