...
def main():
    ...
    p.add_argument("--lookbacks", default="5,21,50", help="Окна SMA/ret в барах для 4h интервала (по умолчанию 5,21,50 = 20h,84h,200h)")
    p.add_argument("--rsi-period", type=int, default=14, help="Период RSI (Wilder)")
    p.add_argument("--yang-zhang-windows", default="12,42,180", help="Окна Yang-Zhang в барах для 4h (по умолчанию 12,42,180 = 48h,7d,30d)")
    ...
    p.add_argument("--taker-buy-ratio-windows", default="2,4,6", help="Окна Taker Buy Ratio SMA в барах для 4h (по умолчанию 2,4,6 = 8h,16h,24h)")
    p.add_argument("--taker-buy-ratio-momentum", default="1,2,3,6", help="Окна Taker Buy Ratio momentum в барах для 4h (по умолчанию 1,2,3,6 = 4h,8h,12h,24h)")
    ...
    p.add_argument("--cvd-windows", default="6,42", help="Окна Cumulative Volume Delta в барах для 4h (по умолчанию 6,42 = 24h,7d)")
    p.add_argument("--parkinson-windows", default="12,42", help="Окна Parkinson волатильности в барах для 4h (по умолчанию 12,42 = 48h,7d)")
    p.add_argument("--garch-windows", default="42,84,180", help="Окна GARCH(1,1) волатильности в барах для 4h (по умолчанию 42,84,180 = 7d,14d,30d)")
    args = p.parse_args()
