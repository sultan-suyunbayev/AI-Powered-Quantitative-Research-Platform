...
graph TD
    ...
    Tab9 --> Sub93[9.3 Claude Interactive CLI]
...
* **Связанный код:** [clock.py](file:///c:/Users/Зефирка/StartUp/clock.py), `services/core/risk_controls/time_sync.py` (класс `ComplianceClock`).
* **Элементы управления на UI:**
...
* **Связанный код:** [drift.py](file:///c:/Users/Зефирка/StartUp/drift.py).
* **Элементы управления на UI:**
...
* **Связанный код:** [ingest_orchestrator.py](file:///c:/Users/Зефирка/StartUp/ingest_orchestrator.py), [ingest_klines.py](file:///c:/Users/Зефирка/StartUp/ingest_klines.py), [ingest_funding_mark.py](file:///c:/Users/Зефирка/StartUp/ingest_funding_mark.py), [cot_data_loader.py](file:///c:/Users/Зефирка/StartUp/cot_data_loader.py), [data_loader_forex.py](file:///c:/Users/Зефирка/StartUp/data_loader_forex.py), [data_loader_multi_asset.py](file:///c:/Users/Зефирка/StartUp/data_loader_multi_asset.py), [prepare_and_run.py](file:///c:/Users/Зефирка/StartUp/prepare_and_run.py).
...
* **Связанный код:** [make_features.py](file:///c:/Users/Зефирка/StartUp/make_features.py), [features_pipeline.py](file:///c:/Users/Зефирка/StartUp/features_pipeline.py), [stock_features.py](file:///c:/Users/Зефирка/StartUp/stock_features.py), [forex_features.py](file:///c:/Users/Зефирка/StartUp/forex_features.py), [transformers.py](file:///c:/Users/Зефирка/StartUp/transformers.py), [feature_config.py](file:///c:/Users/Зефирка/StartUp/feature_config.py), [prepare_and_run.py](file:///c:/Users/Зефирка/StartUp/prepare_and_run.py).
...
* **Связанный код:** [make_costaware_targets.py](file:///c:/Users/Зефирка/StartUp/make_costaware_targets.py), [trainingtcost.py](file:///c:/Users/Зефирка/StartUp/trainingtcost.py).
...
* **Связанный код:** [build_training_table.py](file:///c:/Users/Зефирка/StartUp/build_training_table.py), [asof_join.py](file:///c:/Users/Зефирка/StartUp/asof_join.py), [leakguard.py](file:///c:/Users/Зефирка/StartUp/leakguard.py), [labels.py](file:///c:/Users/Зефирка/StartUp/labels.py).
...
* **Связанный код:** [apply_no_trade_mask.py](file:///c:/Users/Зефирка/StartUp/apply_no_trade_mask.py), [no_trade.py](file:///c:/Users/Зефирка/StartUp/no_trade.py), [dynamic_no_trade_guard.py](file:///c:/Users/Зефирка/StartUp/dynamic_no_trade_guard.py), [no_trade_config.py](file:///c:/Users/Зефирка/StartUp/no_trade_config.py).
...
* **Связанный код:** [make_walkforward_splits.py](file:///c:/Users/Зефирка/StartUp/make_walkforward_splits.py), [splits.py](file:///c:/Users/Зефирка/StartUp/splits.py), [diag_val_split.py](file:///c:/Users/Зефирка/StartUp/diag_val_split.py).
...
* **Связанный код:**
  - [train_model_multi_patch.py](file:///c:/Users/Зефирка/StartUp/train_model_multi_patch.py) — движок RL-обучения (PPO с CVaR, PopArt и VGS).
  - [distributional_ppo.py](file:///c:/Users/Зефирка/StartUp/distributional_ppo.py) — реализация алгоритма Distributional PPO.
  - [training_pbt_adversarial_integration.py](file:///c:/Users/Зефирка/StartUp/training_pbt_adversarial_integration.py) — координатор PBT и состязательного обучения.
  - [service_train.py](file:///c:/Users/Зефирка/StartUp/service_train.py) — оркестратор офлайн ML-обучения.
  - [variance_gradient_scaler.py](file:///c:/Users/Зефирка/StartUp/variance_gradient_scaler.py) — стабилизатор градиентов VGS.
  - [core_models.py](file:///c:/Users/Зефирка/StartUp/core_models.py) — архитектуры нейросетевых моделей.
...
* **Связанный код:**
  - *Калибровка вероятностей:* [train_calibrator.py](file:///c:/Users/Зефирка/StartUp/train_calibrator.py), [apply_calibrator.py](file:///c:/Users/Зефирка/StartUp/apply_calibrator.py), [calibration.py](file:///c:/Users/Зефирка/StartUp/calibration.py).
  - *Конформное оценивание:* [core_conformal.py](file:///c:/Users/Зефирка/StartUp/core_conformal.py), [impl_conformal.py](file:///c:/Users/Зефирка/StartUp/impl_conformal.py), [service_conformal.py](file:///c:/Users/Зефирка/StartUp/service_conformal.py).
* **Элементы управления на UI:**
...
* **Связанный код:** [tune_threshold.py](file:///c:/Users/Зефирка/StartUp/tune_threshold.py), [threshold_tuner.py](file:///c:/Users/Зефирка/StartUp/threshold_tuner.py), [no_trade.py](file:///c:/Users/Зефирка/StartUp/no_trade.py).
* **Элементы управления на UI:**
...
* **Связанный код:** [script_calibrate_tcost.py](file:///c:/Users/Зефирка/StartUp/script_calibrate_tcost.py), [service_calibrate_tcost.py](file:///c:/Users/Зефирка/StartUp/service_calibrate_tcost.py), [script_calibrate_slippage.py](file:///c:/Users/Зефирка/StartUp/script_calibrate_slippage.py), [service_calibrate_slippage.py](file:///c:/Users/Зефирка/StartUp/service_calibrate_slippage.py), [slippage.py](file:///c:/Users/Зефирка/StartUp/slippage.py), [trainingtcost.py](file:///c:/Users/Зефирка/StartUp/trainingtcost.py), [make_costaware_targets.py](file:///c:/Users/Зефирка/StartUp/make_costaware_targets.py), [compare_slippage_curve.py](file:///c:/Users/Зефирка/StartUp/compare_slippage_curve.py).
* **Элементы управления на UI:**
...
* **Связанный код:**
  - [MarketSimulator.h](file:///c:/Users/Зефирка/StartUp/MarketSimulator.h), [MarketSimulator.cpp](file:///c:/Users/Зефирка/StartUp/MarketSimulator.cpp) — движок стохастического генератора баров с поддержкой шоков и режимов рынка.
  - [execution_sim.py](file:///c:/Users/Зефирка/StartUp/execution_sim.py) — движок симуляции исполнения ордеров (ExecutionSimulator v2), эмулирующий LOB (Limit Order Book), задержки и фильтры.
  - [impl_sim_executor.py](file:///c:/Users/Зефирка/StartUp/impl_sim_executor.py) — обертка SimExecutor с интерфейсом TradeExecutor для интеграции с PPO/агентом.
  - [impl_bar_executor.py](file:///c:/Users/Зефирка/StartUp/impl_bar_executor.py), [service_backtest.py](file:///c:/Users/Зефирка/StartUp/service_backtest.py) (класс BarBacktestSimBridge) — движок быстрой симуляции баров (Bar Mode).
  - [fast_lob.cpp](file:///c:/Users/Зефирка/StartUp/fast_lob.cpp), [fast_market.cpp](file:///c:/Users/Зефирка/StartUp/fast_market.cpp), [micro_sim.cpp](file:///c:/Users/Зефирка/StartUp/micro_sim.cpp) — Cython/C++ модули микроструктуры и эмуляции книги лимитных ордеров.
...
* **Связанный код:**
  - [execution_algos.py](file:///c:/Users/Зефирка/StartUp/execution_algos.py) — реализации алгоритмов TakerExecutor, TWAPExecutor, POVExecutor, VWAPExecutor и MidOffsetLimitExecutor.
  - [impl_slippage.py](file:///c:/Users/Зефирка/StartUp/impl_slippage.py) — калибровка и расчет динамического проскальзывания.
  - [service_backtest.py](file:///c:/Users/Зефирка/StartUp/service_backtest.py) (метод _apply_bar_capacity_base_config) — ограничения пропускной способности.
...
* **Связанный код:**
  - [script_backtest.py](file:///c:/Users/Зефирка/StartUp/script_backtest.py) — точка входа CLI бэктеста.
  - [service_backtest.py](file:///c:/Users/Зефирка/StartUp/service_backtest.py) — оркестратор пайплайна бэктеста.
  - [scripts/offline_utils.py](file:///c:/Users/Зефирка/StartUp/scripts/offline_utils.py) — менеджер оффлайн-пайплайнов и фолдов.
...
* **Связанный код:**
  - [service_eval.py](file:///c:/Users/Зефирка/StartUp/service_eval.py) — сервис сбора логов сделок/эквити и вычисления метрик для одного или всех профилей исполнения.
  - [trading_metrics.py](file:///c:/Users/Зефирка/StartUp/trading_metrics.py) — инкрементальный сборщик метрик (TradingMetricsAccumulator) для логирования в RL.
  - [script_compare_runs.py](file:///c:/Users/Зефирка/StartUp/script_compare_runs.py) — утилита агрегации результатов.
  - [services/metrics.py](file:///c:/Users/Зефирка/StartUp/services/metrics.py) — библиотека расчета финансовых коэффициентов.
...
* **Связанный код:**
  ...
  - Скрипты запуска/тестирования: [script_live.py](file:///c:/Users/Зефирка/StartUp/script_live.py), [script_futures_live.py](file:///c:/Users/Зефирка/StartUp/script_futures_live.py).
  - Управляющий сервис: [service_signal_runner.py](file:///c:/Users/Зефирка/StartUp/service_signal_runner.py) (класс [ServiceSignalRunner](file:///c:/Users/Зефирка/StartUp/service_signal_runner.py#L6167)).
* **Архитектурные особенности и запуск:**
  ...
  - **Development Runner:** [script_live.py](file:///c:/Users/Зефирка/StartUp/script_live.py) используется исключительно для локальной отладки и тестирования с возможностью CLI-оверрайдов параметров (размер капитала, ограничения пропускной способность, параметры издержек). Содержит проверку среды `CCEA_PRODUCTION_MODE` для предотвращения ошибочного запуска в проде.
...
* **Связанный код:**
  - Шимы совместимости: [order_shims.py](file:///c:/Users/Зефирка/StartUp/order_shims.py).
  - Логика UI: [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 2476–2523), `adapters/models.py`.
* **Математика и логика трансляции ордеров ([order_shims.py](file:///c:/Users/Зефирка/StartUp/order_shims.py)):**
  - Модель транслирует решения политики `ActionProto` (или legacy-словари) в объекты [OrderIntent](file:///c:/Users/Зефирка/StartUp/core_models.py) и далее в конкретные биржевые ордера [Order](file:///c:/Users/Зефирка/StartUp/core_models.py).
...
* **Связанный код:**
  - Менеджер состояний Python: [domainorder_manager.py](file:///c:/Users/Зефирка/StartUp/domainorder_manager.py) (класс [OrderManager](file:///c:/Users/Зефирка/StartUp/domainorder_manager.py#L64)).
  - Высокопроизводительный C++ трекер: [AgentOrderTracker.h](file:///c:/Users/Зефирка/StartUp/AgentOrderTracker.h) (класс [AgentOrderTracker](file:///c:/Users/Зефирка/StartUp/AgentOrderTracker.h#L18)), обернутый в [lob_state_cython.pyx](file:///c:/Users/Зефирка/StartUp/lob_state_cython.pyx).
  - Интерфейс UI: [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 3680–3992).
* **Спецификация отслеживания состояний (Order Tracking):**
  ...
  - **Алгоритм поиска ближайшего ордера ([find_closest_order](file:///c:/Users/Зефирка/StartUp/AgentOrderTracker.h#L105)):**
...
* **Связанный код:**
  - Базовые интерфейсы: [adapters/base.py](file:///c:/Users/Зефирка/StartUp/adapters/base.py) (классы `BaseAdapter`, `MarketDataAdapter`, `OrderExecutionAdapter`, `FeeAdapter`, `TradingHoursAdapter`).
  ...
  - Динамическое обновление комиссий: [binance_fee_refresh.py](file:///c:/Users/Зефирка/StartUp/binance_fee_refresh.py) (класс `FeeRecord`, функция `load_public_fee_snapshot`).
...
* **Связанный код:**
  ...
  - Синхронизация часов (RTS 25): [services/core/risk_controls/time_sync.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/time_sync.py) (класс `ComplianceClock`).
...
* **Связанный код:**
  - Точка входа: [script_futures_live.py](file:///c:/Users/Зефирка/StartUp/script_futures_live.py).
...
* **Связанный код:**
  - Алгоритмы выполнения: [execution_algos.py](file:///c:/Users/Зефирка/StartUp/execution_algos.py) (классы `TWAPExecutor`, `VWAPExecutor`, `POVExecutor`, `TakerExecutor`, `MidOffsetLimitExecutor`).
  - Ограничения участия: в [script_live.py](file:///c:/Users/Зефирка/StartUp/script_live.py) (параметр `--execution-max-participation`).
...
* **Связанный код:**
  - [services/stock_risk_guards.py](file:///c:/Users/Зефирка/StartUp/services/stock_risk_guards.py) — классы `MarginGuard`, `ShortSaleGuard`, `CorporateActionsHandler`.
  - [services/pdt_guard.py](file:///c:/Users/Зефирка/StartUp/services/pdt_guard.py) — проверка правила Pattern Day Trader.
  - [services/pdt_tracker.py](file:///c:/Users/Зефирка/StartUp/services/pdt_tracker.py) — отслеживание Day-Trade транзакций.
  - [risk_guard.py](file:///c:/Users/Зефирка/StartUp/risk_guard.py) — класс `StockRiskGuard`.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [services/forex_risk_guards.py](file:///c:/Users/Зефирка/StartUp/services/forex_risk_guards.py) — классы `ForexMarginGuard`, `ForexLeverageGuard`, `SwapCostTracker`.
  - [services/forex_requote.py](file:///c:/Users/Зефирка/StartUp/services/forex_requote.py) — симулятор OTC-реквотов дилера `RequoteFlowSimulator` и модели вероятности `RequoteProbabilityModel`.
  - [services/forex_realtime_swaps.py](file:///c:/Users/Зефирка/StartUp/services/forex_realtime_swaps.py) — real-time трекинг своп-тарифов.
  - [swap_rates_provider.py](file:///c:/Users/Зефирка/StartUp/swap_rates_provider.py) — коннектор к OANDA / сторонним API.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [services/cme_risk_guards.py](file:///c:/Users/Зефирка/StartUp/services/cme_risk_guards.py) — классы `CMEFuturesRiskGuard`, `SPANMarginGuard`, `CMEPositionLimitGuard`, `CircuitBreakerAwareGuard`, `SettlementRiskGuard`, `RolloverGuard`.
  - [services/unified_futures_risk.py](file:///c:/Users/Зефирка/StartUp/services/unified_futures_risk.py) — объединенный решатель маржинальных требований фьючерсов.
  - [services/futures_margin_monitor.py](file:///c:/Users/Зефирка/StartUp/services/futures_margin_monitor.py) — мониторинг маржи в реальном времени.
  - [impl_circuit_breaker.py](file:///c:/Users/Зефирка/StartUp/impl_circuit_breaker.py) — симулятор лимитов Overnight Limit Up/Limit Down и Velocity Logic для CME.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [impl_greeks_vectorized.py](file:///c:/Users/Зефирка/StartUp/impl_greeks_vectorized.py) — векторизованный Black-Scholes калькулятор.
  - [impl_greeks.py](file:///c:/Users/Зефирка/StartUp/impl_greeks.py) — базовый калькулятор греков.
  - [impl_iv_calculation.py](file:///c:/Users/Зефирка/StartUp/impl_iv_calculation.py) — численный расчет Implied Volatility (IV) методом Ньютона-Рафсона.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [services/portfolio_constraints.py](file:///c:/Users/Зефирка/StartUp/services/portfolio_constraints.py) — проверка структуры весов портфеля.
  - [risk_guard.py](file:///c:/Users/Зефирка/StartUp/risk_guard.py) — класс `PortfolioLimitGuard` и `PortfolioLimitConfig`.
  - [portfolio_allocator.py](file:///c:/Users/Зефирка/StartUp/portfolio_allocator.py) — детерминированный аллокатор весов портфеля с ограничением gross exposure.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [services/trading_halts.py](file:///c:/Users/Зефирка/StartUp/services/trading_halts.py) — детекция остановок торгов.
  - [services/ops_kill_switch.py](file:///c:/Users/Зефирка/StartUp/services/ops_kill_switch.py) — кулдаун и файлы-флаги блокировок.
  - [services/core/risk_controls/kill_switch.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/kill_switch.py) — класс `EnhancedKillSwitch`.
  - [impl_circuit_breaker.py](file:///c:/Users/Зефирка/StartUp/impl_circuit_breaker.py) — CME Globex Circuit Breaker Rule 80B и планки ценовых ограничений.
...
* **Связанный код:**
  - [services/futures_risk_guards.py](file:///c:/Users/Зефирка/StartUp/services/futures_risk_guards.py) — класс `FuturesRiskGuard` и его составляющие.
  - [risk_guard.py](file:///c:/Users/Зефирка/StartUp/risk_guard.py) — класс `CryptoFuturesRiskGuard` и `CryptoFuturesRiskConfig`.
  - [services/futures_funding_tracker.py](file:///c:/Users/Зефирка/StartUp/services/futures_funding_tracker.py) — трекинг ставок финансирования.
* **Технические особенности:**
...
* **Связанный код:**
  - [leakguard.py](file:///c:/Users/Зефирка/StartUp/leakguard.py) — класс `LeakGuard` и конфигурация `LeakConfig`.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [risk_manager.pyx](file:///c:/Users/Зефирка/StartUp/risk_manager.pyx) — высокопроизводительный Cython-модуль риск-менеджера среды симулятора.
  - [risk_guard.py](file:///c:/Users/Зефирка/StartUp/risk_guard.py) — классы `RiskGuard`, `SimpleRiskGuard`, `RiskConfig`.
  - [risk.py](file:///c:/Users/Зефирка/StartUp/risk.py) — базовые проверки в песочнице.
  - [impl_risk_basic.py](file:///c:/Users/Зефирка/StartUp/impl_risk_basic.py) — базовый исполнитель проверок.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - [dynamic_no_trade_guard.py](file:///c:/Users/Зефирка/StartUp/dynamic_no_trade_guard.py) — онлайн-оценщик правил динамического no-trade `DynamicNoTradeGuard`.
  - [no_trade.py](file:///c:/Users/Зефирка/StartUp/no_trade.py) — исторические no-trade маски, календарь макрособытий.
  - [no_trade_config.py](file:///c:/Users/Зефирка/StartUp/no_trade_config.py) — конфигурация `DynamicGuardConfig`.
* **Технические особенности и формулы:**
...
* **Связанный код:**
  - Модуль верификации: [verifier.py](file:///c:/Users/Зефирка/StartUp/ccea/artifact/verifier.py) (класс `ArtifactVerifier`), `ccea/artifact/signer.py` (класс `SignatureInfo`).
...
* **Связанный код:**
  - Демон агента: [agentd.py](file:///c:/Users/Зефирка/StartUp/packages/agent/daemon/agentd.py) (методы `_process_cloud_commands`, `_execute_cloud_command`).
...
* **Связанный код:**
  ...
  - Интеграция с ОС Keychain: [keychain.py](file:///c:/Users/Зефирка/StartUp/packages/agent/daemon/keychain.py) (класс `KeychainManager`, конфигурация `KeychainConfig`).
...
* **Связанный код:**
  - Менеджер состояния: [state_store.py](file:///c:/Users/Зефирка/StartUp/state_store.py) (класс `StateStore`).
...
* **Связанный код:**
  - Модуль проверок: [preflight.py](file:///c:/Users/Зефирка/StartUp/packages/agent/daemon/preflight.py) (классы `PreflightChecker`, `PreflightCheck`, `PreflightResult`).
...
* **Связанный код:**
  - Диспетчер автономности: [degraded_mode.py](file:///c:/Users/Зефирка/StartUp/packages/agent/daemon/degraded_mode.py) (класс `DegradedModeManager`, конфиг `DegradedModeConfig`).
...
* **Связанный код:**
  ...
  - Менеджер Kill Switch: [kill_switch.py](file:///c:/Users/Зефирка/StartUp/packages/agent/daemon/kill_switch.py) (классы `KillSwitchManager`, `HaltReason`, `HaltEvent`, `KillSwitchConfig`), `packages/agent/daemon/kill_switch_executor.py`.
* **Технические особенности и спецификации:**
...
* **Связанный код:**
  - Docker Compose: [docker-compose.yml](file:///c:/Users/Зефирка/StartUp/deploy/docker/docker-compose.yml).
  - Air-Gapped Overlay: [docker-compose.airgapped.yml](file:///c:/Users/Зефирка/StartUp/deploy/docker/docker-compose.airgapped.yml).
...
1. **Universal Risk Controls** (Универсальные контроли): Базовые контроли рисков, механизмы сбора аудита и проверки дрейфа времени, применяемые к ядру платформы. Код: [services/core/risk_controls/](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/).
2. **B2B Compliance Toolkit** (Интеграционный инструментарий B2B): Набор инструментов для институциональных клиентов, включая conformance-тестирование алгоритмов, анализ наилучшего исполнения и маршрутизации заявок. Код: [services/algo_integration/](file:///c:/Users/Зефирка/StartUp/services/algo_integration/).
3. **Archived Financial Entity Modules** (Архивные модули): Комплаенс-модули для инвестиционных фирм (GLEIF, ARM-клиент, отправка отчетов регуляторам). Перенесены в архив: [archive/deprecated/services_archive/mifid_financial_entity/](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/) и [services/archive/dora_financial_entity/](file:///c:/Users/Зефирка/StartUp/services/archive/dora_financial_entity/).
...
* **Связанный код:**
  * **Универсальные контроли аудита:** [services/core/risk_controls/audit_models.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_models.py) (модели [AuditRecord](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_models.py#L12), [AuditRecordBuilder](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_models.py#L14), перечисления [AuditEventType](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_models.py#L6), [AuditRecordPriority](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_models.py#L7)), [services/core/risk_controls/audit_storage.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_storage.py) ([MemoryAuditStorage](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_storage.py#L32), [SQLiteAuditStorage](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_storage.py#L34), [FileAuditStorage](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_storage.py#L36)), [services/core/risk_controls/audit_trail_writer.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_trail_writer.py) ([AuditTrailWriter](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/audit_trail_writer.py#L46) с поддержкой криптографического хеширования цепочек логов для защиты от изменения данных).
  * **Синхронизация часов (RTS 25):** [services/core/risk_controls/time_sync.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/time_sync.py) ([ComplianceClock](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/time_sync.py#L149) для отслеживания дрейфа времени относительно серверов NTP и HTTP с точностью до микросекунд, [ClockDriftSeverity](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/time_sync.py#L144), [ClockSyncStatus](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/time_sync.py#L146)).
  * **Интеграционный B2B-инструментарий:** [services/algo_integration/conformance_testing.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/conformance_testing.py) ([ConformanceTestRunner](file:///c:/Users/Зефирка/StartUp/services/algo_integration/conformance_testing.py#L239), [ConformanceTestSuite](file:///c:/Users/Зефирка/StartUp/services/algo_integration/conformance_testing.py#L234) для автоматического стресс-тестирования алгоритмов перед развертыванием), [services/algo_integration/best_execution.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/best_execution.py) ([BestExecutionPolicy](file:///c:/Users/Зефирка/StartUp/services/algo_integration/best_execution.py#L186), [BestExecutionAnalyzer](file:///c:/Users/Зефирка/StartUp/services/algo_integration/best_execution.py#L188) для оценки качества исполнения заявок по различным факторам), [services/algo_integration/venue_analysis.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/venue_analysis.py) ([VenueAnalyzer](file:///c:/Users/Зефирка/StartUp/services/algo_integration/venue_analysis.py#L334) для оценки перформанса торговых площадок, [SmartOrderRouter](file:///c:/Users/Зефирка/StartUp/services/algo_integration/venue_analysis.py#L336)), [services/algo_integration/execution_quality_report.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/execution_quality_report.py) ([ExecutionQualityReportGenerator](file:///c:/Users/Зефирка/StartUp/services/algo_integration/execution_quality_report.py#L259) для компиляции квартальных отчетов RTS 27/28), [services/algo_integration/certification.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/certification.py) ([CertificateManager](file:///c:/Users/Зефирка/StartUp/services/algo_integration/certification.py#L203), [ConformanceCertificate](file:///c:/Users/Зефирка/StartUp/services/algo_integration/certification.py#L201) для выпуска электронных сертификатов готовности алгоритмов).
  * **Архивированные модули финансовой организации (deprecated):** [archive/deprecated/services_archive/mifid_financial_entity/lei_manager.py](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/lei_manager.py) ([LEIManager](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/lei_manager.py#L318)), [archive/deprecated/services_archive/mifid_financial_entity/arm_client.py](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/arm_client.py) ([ARMClient](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/arm_client.py#L352)), [archive/deprecated/services_archive/mifid_financial_entity/transaction_report.py](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/transaction_report.py) ([TransactionReportBuilder](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/transaction_report.py#L342)), [archive/deprecated/services_archive/mifid_financial_entity/self_assessment.py](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/self_assessment.py) ([AnnualSelfAssessment](file:///c:/Users/Зефирка/StartUp/archive/deprecated/services_archive/mifid_financial_entity/self_assessment.py#L373) по опроснику RTS 6).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **Риски и соответствие:** [services/ai_act/risk_registry.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/risk_registry.py) (системный журнал рисков ИИ [RiskRegistry](file:///c:/Users/Зефирка/StartUp/services/ai_act/risk_registry.py#L653), автоматические проверки пороговых параметров), [services/ai_act/risk_management.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/risk_management.py) ([AIActRiskManager](file:///c:/Users/Зефирка/StartUp/services/ai_act/risk_management.py#L642) для непрерывного отслеживания рисков и мер минимизации).
  * **Объяснимость решений:** [services/ai_act/explainability.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/explainability.py) ([DecisionExplainer](file:///c:/Users/Зефирка/StartUp/services/ai_act/explainability.py#L492), генерация локальных объяснений решений модели торговой логики с расчетом важности признаков по SHAP/LIME и генерацией человекочитаемого текста обоснования сделки).
  * **Модельные карты и раскрытие информации:** [services/ai_act/gpai_model_card.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/gpai_model_card.py) ([GPAIModelCard](file:///c:/Users/Зефирка/StartUp/services/ai_act/gpai_model_card.py#L512) для генерации паспортов моделей общего назначения), [services/ai_act/transparency_disclosure.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/transparency_disclosure.py) ([TransparencyDisclosureManager](file:///c:/Users/Зефирка/StartUp/services/ai_act/transparency_disclosure.py#L744) для уведомления пользователей об использовании ИИ).
  * **Управление данными и версионирование:** [services/ai_act/data_governance.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/data_governance.py) ([DataGovernanceFramework](file:///c:/Users/Зефирка/StartUp/services/ai_act/data_governance.py#L461) для автоматического контроля качества данных, отсутствия пропусков и смещений), [services/ai_act/data_lineage.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/data_lineage.py) ([DataLineageTracker](file:///c:/Users/Зефирка/StartUp/services/ai_act/data_lineage.py#L479) для отслеживания полного графа происхождения фичей и версий обучающих наборов данных), [services/ai_act/training_data_summary.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/training_data_summary.py) ([TrainingDataSummaryManager](file:///c:/Users/Зефирка/StartUp/services/ai_act/training_data_summary.py#L730) для генерации открытого описания источников данных по ст. 53).
  * **Качество и аудит кода:** [services/ai_act/conformity_assessment.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/conformity_assessment.py) ([ConformitySelfAssessment](file:///c:/Users/Зефирка/StartUp/services/ai_act/conformity_assessment.py#L380) для прохождения чек-листа соответствия и автоматического формирования Декларации соответствия ЕС), [services/ai_act/technical_documentation.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/technical_documentation.py) ([TechnicalDocumentationGenerator](file:///c:/Users/Зефирка/StartUp/services/ai_act/technical_documentation.py#L688) для создания полного пакета техдокументации по Приложению IV).
  * **Надежность и кибербезопасность (ст. 15):** [services/ai_act/robustness_testing.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/robustness_testing.py) ([RobustnessTestSuite](file:///c:/Users/Зефирка/StartUp/services/ai_act/robustness_testing.py#L673) для симуляции состязательных атак, дрейфа ковариат и экстремальных граничных условий), [services/ai_act/cybersecurity.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/cybersecurity.py) ([AIActCybersecurity](file:///c:/Users/Зефирка/StartUp/services/ai_act/cybersecurity.py#L431) для верификации цифровых подписей моделей и предотвращения отравления данных), [services/ai_act/accuracy_metrics.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/accuracy_metrics.py) ([AccuracyMonitor](file:///c:/Users/Зефирка/StartUp/services/ai_act/accuracy_metrics.py#L355) для трекинга качества прогнозирования модели в реальном времени).
  * **Человеческий контроль и протоколирование:** [services/ai_act/human_oversight.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/human_oversight.py) ([HumanOversightSystem](file:///c:/Users/Зефирка/StartUp/services/ai_act/human_oversight.py#L540) для реализации вето-прав человека, ручного переопределения позиций и мониторинга automation bias), [services/ai_act/logging_system.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/logging_system.py) ([AIActLogger](file:///c:/Users/Зефирка/StartUp/services/ai_act/logging_system.py#L557) для ведения неизменяемого лога решений ИИ по ст. 12).
  * **Пост-рыночный мониторинг:** [services/ai_act/post_market_monitoring.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/post_market_monitoring.py) ([PostMarketMonitoringSystem](file:///c:/Users/Зефирка/StartUp/services/ai_act/post_market_monitoring.py#L592) для сбора инцидентов, пользовательского фидбека и контроля деградации модели в эксплуатации), [services/ai_act/qms.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/qms.py) ([QualityManagementSystem](file:///c:/Users/Зефирка/StartUp/services/ai_act/qms.py#L625) для ведения процедур качества, корректирующих действий CAPA и изменений архитектур ИИ).
  * **Авторское право:** [services/ai_act/copyright_compliance.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/copyright_compliance.py) ([CopyrightComplianceManager](file:///c:/Users/Зефирка/StartUp/services/ai_act/copyright_compliance.py#L395) для проверки правомерности использования данных и соблюдения исключений TDM).
  * **Согласия пользователей:** [services/ai_act/user_acknowledgment.py](file:///c:/Users/Зефирка/StartUp/services/ai_act/user_acknowledgment.py) ([UserAcknowledgmentManager](file:///c:/Users/Зефирка/StartUp/services/ai_act/user_acknowledgment.py#L760) для сбора согласий клиентов).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **Реализация GDPR:** [services/gdpr/data_export.py](file:///c:/Users/Зефирка/StartUp/services/gdpr/data_export.py) ([GDPRExportService](file:///c:/Users/Зефирка/StartUp/services/gdpr/data_export.py#L827) для сбора всех пользовательских стратегий, параметров бэктестов, логов исполнений и настроек в единый ZIP-архив), [services/gdpr/data_deletion.py](file:///c:/Users/Зефирка/StartUp/services/gdpr/data_deletion.py) ([GDPRDeletionService](file:///c:/Users/Зефирка/StartUp/services/gdpr/data_deletion.py#L791) для анонимизации и удаления персональных данных пользователей).
  * **Политика хранения и архивирования:** [services/core/risk_controls/retention_policy.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/retention_policy.py) ([RetentionManager](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/retention_policy.py#L138) для управления жизненным циклом логов, отслеживания сроков `RetentionPeriod`, обработки запросов регуляторов `NCARequest`, применения режима блокировки удаления (legal hold)).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **Мониторинг соотношения OTR:** [services/algo_integration/otr_monitor.py](file:///c:/Users/Зефирка/StartUp/services/algo_integration/otr_monitor.py) ([OTRMonitor](file:///c:/Users/Зефирка/StartUp/services/algo_integration/otr_monitor.py#L277) для расчета OTR по объемам и количеству транзакций в скользящих окнах для каждой биржевой площадки и торгового алгоритма, [PerVenueOTR](file:///c:/Users/Зефирка/StartUp/services/algo_integration/otr_monitor.py#L273), [PerAlgorithmOTR](file:///c:/Users/Зефирка/StartUp/services/algo_integration/otr_monitor.py#L275), фиксация превышений [OTRBreachEvent](file:///c:/Users/Зефирка/StartUp/services/algo_integration/otr_monitor.py#L270) с автоматическим троттлингом или блокировкой заявок).
  * **Мониторинг в реальном времени:** [services/core/risk_controls/realtime_monitor.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/realtime_monitor.py) ([RealTimeMonitor](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/realtime_monitor.py#L123) для сбора метрик задержки выполнения ордеров, загрузки процессора, скорости сообщений, генерации алертов `ComplianceAlert`).
  * **Pre-Trade проверки лимитов рисков:** [services/core/risk_controls/pre_trade_controls.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/pre_trade_controls.py) ([PreTradeControls](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/pre_trade_controls.py#L109) для валидации максимального объема ордера, максимальной стоимости, ценового коридора (Price Collar / Fat-Finger Check), лимитов по позициям и ограничения скорости сообщений `MessageRateWindow`).
  * **Экстренная остановка (RTS 6 Article 12):** [services/core/risk_controls/kill_switch.py](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/kill_switch.py) ([EnhancedKillSwitch](file:///c:/Users/Зефирка/StartUp/services/core/risk_controls/kill_switch.py#L95) для моментального отзыва активных ордеров и блокировки отправки новых заявок на уровне конкретного торгового робота, инструмента или всей площадки).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **API сохранения и валидации:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 2151–2258, функции `api_get_strategy_templates`, `api_get_strategy`, `api_save_strategy`).
...
* **Связанный код:**
  * **API редактирования YAML:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 3162–3179, функции `api_yaml_get`, `api_yaml_save`).
  * **Применение калибровки:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 3180–3220, функция `api_config_apply_calibration`), `apply_calibrator.py`.
  * **Сохранение квантайзера:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 3288–3304, функция `api_quantizer_save`).
* **Элементы управления на UI:**
...
#### Подвкладка 9.3: Claude Interactive CLI & Job Router (Эмулятор веб-терминала)
...
* **Связанный код:**
  * **Эмулятор терминала:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 2781–3104, функции `api_terminal_cd`, `api_terminal_start`, `api_terminal_status`, `api_terminal_kill`, `api_terminal_run`).
  * **Мониторинг фоновых задач:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 2547–2563, функции `api_job_status`, `api_job_stop`).
  * **Джоб-раннер:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 4342–5897, функция `api_run_job`).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **Чтение логов:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линия 2539–2546, функция `api_logs`), `secure_logging.py`.
  * **Логирование:** `services/core/structured_logging.py` (классы `StructuredLogger`, `ContextualLogger`, `StructuredFormatter`).
  * **Предпросмотр данных:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 3119–3161, функция `api_data_preview`).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **API оптимизатора:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 2264–2325, функции `api_optimize`, `api_optimize_results`).
  * **Скрипт оптимизации:** [optimize_parameters.py](file:///c:/Users/Зефирка/StartUp/scripts/optimize_parameters.py) (генерация сетки `generate_grid`, бэктест-цикл, Black-Scholes функции `calculate_black_scholes_delta` и `calculate_black_scholes_premium`).
* **Элементы управления на UI:**
...
* **Связанный код:**
  * **Обработка команд:** [app.py](file:///c:/Users/Зефирка/StartUp/app.py) (линии 5898–5987, функция `api_copilot`), `utils/` и системные вызовы управления процессами.
* **Элементы управления на UI:**
